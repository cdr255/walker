...
pkgdatadir = $(datadir)/walker
pkgincludedir = $(includedir)/walker
pkglibdir = $(libdir)/walker
pkglibexecdir = $(libexecdir)/walker
...
ACLOCAL = ${SHELL} /home/chrissofer/code/walker/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AUTOCONF = ${SHELL} /home/chrissofer/code/walker/missing --run autoconf
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/chrissofer/code/walker/missing --run makeinfo
...
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = /usr/local/lib/pkgconfig:/usr/lib/pkgconfig:/usr/local/lib/pkgconfig:/usr/local/lib/pkgconfig:/usr/local/lib/pkgconfig:/usr/local/lib/pkgconfig
SET_MAKE = 
SFML_CFLAGS =  
SFML_LIBS = -lsfml-graphics -lsfml-audio -lsfml-network -lsfml-window -lsfml-system  
SHELL = /bin/sh
STRIP = 
VERSION = 0.1
abs_builddir = /home/chrissofer/code/walker
...
install_sh = ${SHELL} /home/chrissofer/code/walker/install-sh
...
walker$(EXEEXT): $(walker_OBJECTS) $(walker_DEPENDENCIES) $(EXTRA_walker_DEPENDENCIES) 
	@rm -f walker$(EXEEXT)
	$(walker_LINK) $(walker_OBJECTS) $(walker_LDADD) $(LIBS)
...
walker-main.o: src/main.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(walker_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT walker-main.o -MD -MP -MF $(DEPDIR)/walker-main.Tpo -c -o walker-main.o `test -f 'src/main.cpp' || echo '$(srcdir)/'`src/main.cpp
	$(am__mv) $(DEPDIR)/walker-main.Tpo $(DEPDIR)/walker-main.Po
#	source='src/main.cpp' object='walker-main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(walker_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -c -o walker-main.o `test -f 'src/main.cpp' || echo '$(srcdir)/'`src/main.cpp

walker-main.obj: src/main.cpp
	$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(walker_CPPFLAGS) $(CPPFLAGS) $(AM_CXXFLAGS) $(CXXFLAGS) -MT walker-main.obj -MD -MP -MF $(DEPDIR)/walker-main.Tpo -c -o walker-main.obj `if test -f 'src/main.cpp'; then $(CYGPATH_W) 'src/main.cpp'; else $(CYGPATH_W) '$(srcdir)/src/main.cpp'; fi`
	$(am__mv) $(DEPDIR)/walker-main.Tpo $(DEPDIR)/walker-main.Po
